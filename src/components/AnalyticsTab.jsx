...
const AnalyticsTab = () => {
    ...
    if (isLoading) {
        return <div className="text-center text-gray-300">Loading analytics data...</div>;
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <AnalyticsCard
                    ...
                    icon={ShoppingCart}
                    color="from-blue-500 to-emerald-700"
                />
                <AnalyticsCard
                    title="Total Revenue"
                    value={`$${(analyticsData?.totalRevenue || 0).toLocaleString()}`}
                    icon={DollarSign}
                    color="from-bue-500 to-pink-700"
                />
            </div>
            <motion.div
...
const AnalyticsCard = ({ title, value, icon: Icon, color }) => (
    ...
    >
        <div className="flex justify-between items-center">
            <div className="z-10">
                <p className="text--300 text-sm mb-1 font-semibold">
                    {title}
                </p>
